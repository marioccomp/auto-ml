...
- CSS fica ao lado do componente que estiliza, usando classes BEM simples e tokens globais.
...
- Componentes novos devem respeitar os tokens existentes: `--color-*`, `--space-*`, `--radius-*` e `--shadow-*`.
